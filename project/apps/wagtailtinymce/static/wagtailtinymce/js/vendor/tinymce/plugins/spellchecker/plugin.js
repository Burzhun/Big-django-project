...
var spellchecker = (function () {
  ...
  var $_56j6qdiojcg9mb7o = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      XHR.send({
        url: new URI(pluginUrl).toAbsolute($_8zte38iqjcg9mb7q.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_8zte38iqjcg9mb7q.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_8zte38iqjcg9mb7q.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_a756dnivjcg9mb7v.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_8zte38iqjcg9mb7q.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_a756dnivjcg9mb7v.fireSpellcheckStart(editor);
  };
  var $_87kb7nirjcg9mb7s = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, url) {
    var getLanguage = function () {
      return $_8zte38iqjcg9mb7q.getLanguage(editor);
    };
    var getWordCharPattern = function () {
      return $_8zte38iqjcg9mb7q.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_87kb7nirjcg9mb7s.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_a9yk1oipjcg9mb7p = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_87kb7nirjcg9mb7s.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_8gf4ntixjcg9mb83 = { register: register };
  ...
  var updateSelection = function (editor) {
    return function (e) {
      var selectedLanguage = $_8zte38iqjcg9mb7q.getLanguage(editor);
  ...
  var getItems = function (editor) {
    return Tools.map($_8zte38iqjcg9mb7q.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_2ruichiyjcg9mb85 = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, word, spans) {
    ...
    Tools.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_87kb7nirjcg9mb7s.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_87kb7nirjcg9mb7s.addToDictionary(editor, pluginUrl, startedState, textMatcherState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_87kb7nirjcg9mb7s.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_87kb7nirjcg9mb7s.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_87kb7nirjcg9mb7s.findSpansByIndex(editor, $_87kb7nirjcg9mb7s.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_6p5n50izjcg9mb86 = { setup: setup };

  PluginManager.add('spellchecker', function (editor, pluginUrl) {
    if ($_56j6qdiojcg9mb7o.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_8zte38iqjcg9mb7q.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell({});
      $_2ruichiyjcg9mb85.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_6p5n50izjcg9mb86.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState);
      $_8gf4ntixjcg9mb83.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_a9yk1oipjcg9mb7p.get(editor, startedState, lastSuggestionsState, textMatcherState, pluginUrl);
    }
  });
  var Plugin = function () {
  };
