...
var searchreplace = (function () {
  ...
  var $_f86zemihjcg9mb6o = { findAndReplaceDOMText: findAndReplaceDOMText };
  ...
  var markAllMatches = function (editor, currentIndexState, regex) {
    ...
    return $_f86zemihjcg9mb6o.findAndReplaceDOMText(regex, node, marker, false, editor.schema);
  };
  ...
  var get = function (editor, currentIndexState) {
    var done = function (keepEditorSelection) {
      return $_8qk7pifjcg9mb6i.done(editor, currentIndexState, keepEditorSelection);
    };
    var find = function (text, matchCase, wholeWord) {
      return $_8qk7pifjcg9mb6i.find(editor, currentIndexState, text, matchCase, wholeWord);
    };
    var next = function () {
      return $_8qk7pifjcg9mb6i.next(editor, currentIndexState);
    };
    var prev = function () {
      return $_8qk7pifjcg9mb6i.prev(editor, currentIndexState);
    };
    var replace = function (text, forward, all) {
      return $_8qk7pifjcg9mb6i.replace(editor, currentIndexState, text, forward, all);
    };
    return {
      done: done,
      find: find,
  ...
  var open = function (editor, currentIndexState) {
    ...
    function updateButtonStates() {
      win.statusbar.find('#next').disabled($_8qk7pifjcg9mb6i.hasNext(editor, currentIndexState) === false);
      win.statusbar.find('#prev').disabled($_8qk7pifjcg9mb6i.hasPrev(editor, currentIndexState) === false);
    }
    ...
    var win = editor.windowManager.open({
      ...
      onClose: function () {
        editor.focus();
        $_8qk7pifjcg9mb6i.done(editor, currentIndexState);
        editor.undoManager.add();
      },
      onSubmit: function (e) {
        ...
        if (!text.length) {
          $_8qk7pifjcg9mb6i.done(editor, currentIndexState, false);
          win.statusbar.items().slice(1).disabled(true);
          return;
        }
        if (last.text === text && last.caseState === caseState && last.wholeWord === wholeWord) {
          if (!$_8qk7pifjcg9mb6i.hasNext(editor, currentIndexState)) {
            notFoundAlert();
            return;
          }
          $_8qk7pifjcg9mb6i.next(editor, currentIndexState);
          updateButtonStates();
          return;
        }
        count = $_8qk7pifjcg9mb6i.find(editor, currentIndexState, text, caseState, wholeWord);
        if (!count) {
          notFoundAlert();
        }
      ...
      buttons: [
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            if (!$_8qk7pifjcg9mb6i.replace(editor, currentIndexState, win.find('#replace').value())) {
              win.statusbar.items().slice(1).disabled(true);
              currentIndexState.set(-1);
              last = {};
            }
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            $_8qk7pifjcg9mb6i.replace(editor, currentIndexState, win.find('#replace').value(), true, true);
            win.statusbar.items().slice(1).disabled(true);
            last = {};
          }
        },
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            $_8qk7pifjcg9mb6i.prev(editor, currentIndexState);
            updateButtonStates();
          }
        },
        {
  ...
  var $_3tvpsvijjcg9mb6s = { open: open };

  var register = function (editor, currentIndexState) {
    editor.addCommand('SearchReplace', function () {
      $_3tvpsvijjcg9mb6s.open(editor, currentIndexState);
    });
  };
  var $_5mm7toiijcg9mb6r = { register: register };
  ...
  var $_fu45k4ikjcg9mb6u = { register: register$1 };

  PluginManager.add('searchreplace', function (editor) {
    var currentIndexState = Cell(-1);
    $_5mm7toiijcg9mb6r.register(editor, currentIndexState);
    $_fu45k4ikjcg9mb6u.register(editor, currentIndexState);
    return $_58ugpsiejcg9mb6f.get(editor, currentIndexState);
  });
  var Plugin = function () {
  };
