...
var tabfocus = (function () {
  ...
  var $_8emx4kjbjcg9mb97 = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_8emx4kjbjcg9mb97.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_84v981j4jcg9mb94 = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_84v981j4jcg9mb94.setup(editor);
  });
  var Plugin = function () {
  };
