...
var toc = (function () {
  ...
  var $_1c3nimqkjcg9mcfw = { create: create };

  var tocId = $_1c3nimqkjcg9mcfw.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_4z6uuqqjjcg9mcfv.getTocClass(editor);
    var headerTag = $_4z6uuqqjjcg9mcfv.getTocHeader(editor);
    var selector = generateSelector($_4z6uuqqjjcg9mcfv.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_4z6uuqqjjcg9mcfv.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_4z6uuqqjjcg9mcfv.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_g7tvikqfjcg9mcfr.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_g7tvikqfjcg9mcfr.updateToc(editor);
    });
  };
  var $_c10u54qejcg9mcfp = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_4z6uuqqjjcg9mcfv.getTocClass(editor);
  ...
  var $_98qiugqljcg9mcfx = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_g7tvikqfjcg9mcfr.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_4z6uuqqjjcg9mcfv.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_4oo1fuqmjcg9mcfy = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_c10u54qejcg9mcfp.register(editor);
    $_4oo1fuqmjcg9mcfy.register(editor);
    $_98qiugqljcg9mcfx.setup(editor);
  });
  var Plugin = function () {
  };
