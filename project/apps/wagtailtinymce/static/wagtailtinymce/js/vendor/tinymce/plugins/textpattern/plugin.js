...
var textpattern = (function () {
  ...
  var $_8k9aicq3jcg9mcey = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_5pxsvyqbjcg9mcfb.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_5pxsvyqbjcg9mcfb.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_5pxsvyqbjcg9mcfb.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_5wijgtq8jcg9mcf5.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_5wijgtq8jcg9mcf5.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_5wijgtq8jcg9mcf5.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !VK.modifierPressed(e)) {
        $_1fde6uq7jcg9mcf2.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_1fde6uq7jcg9mcf2.checkKeyCode(keyCodes, e)) {
        $_1fde6uq7jcg9mcf2.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_1fde6uq7jcg9mcf2.checkCharCode(charCodes, e)) {
  ...
  var $_7ucywzq4jcg9mcez = { setup: setup };

  PluginManager.add('textpattern', function (editor) {
    var patternsState = Cell($_8k9aicq3jcg9mcey.getPatterns(editor.settings));
    $_7ucywzq4jcg9mcez.setup(editor, patternsState);
    return $_bv1alfq2jcg9mcew.get(patternsState);
  });
  var Plugin = function () {
  };
