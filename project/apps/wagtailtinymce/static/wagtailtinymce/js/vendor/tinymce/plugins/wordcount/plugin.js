...
var wordcount = (function () {
  ...
  var $_do2e7qrqjcg9mcj7 = {
    each: each,
    map: map
  };

  var SETS$1 = $_7o1kirojcg9mcj0.SETS;
  var OTHER = $_7o1kirojcg9mcj0.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_do2e7qrqjcg9mcj7.map(string.split(''), memoized);
  };
  var $_aeald5rpjcg9mcj6 = { classify: classify };

  var ci = $_7o1kirojcg9mcj0.characterIndices;
  ...
  var $_6zkn9urrjcg9mcj8 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING = $_7o1kirojcg9mcj0.EMPTY_STRING;
  var WHITESPACE = $_7o1kirojcg9mcj0.WHITESPACE;
  var PUNCTUATION = $_7o1kirojcg9mcj0.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_aeald5rpjcg9mcj6.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_6zkn9urrjcg9mcj8.isWordBoundary(map, i)) {
  ...
  var $_epmotjrnjcg9mciy = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_epmotjrnjcg9mciy.getWords(getTextContent(editor)).length;
  };
  var $_4a22m3rmjcg9mcix = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_4a22m3rmjcg9mcix.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_8f5e6rljcg9mcix = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_4a22m3rmjcg9mcix.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_aaj5f3rsjcg9mcja = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_aaj5f3rsjcg9mcja.setup(editor);
    return $_8f5e6rljcg9mcix.get(editor);
  });
  var Plugin = function () {
  };
