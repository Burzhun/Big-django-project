...
var inlite = (function () {
  ...
  var $_eby3je164jcg9mewx = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_8q4pp9168jcg9mex0.fromClientRect(clientRect)) : null;
  };
  var $_cvcbgp167jcg9mewz = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          return $_3r0gh7166jcg9mewy.result(predicateIds[i].id, $_cvcbgp167jcg9mewz.getElementRect(editor, element));
        }
      }
      return null;
    };
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_3r0gh7166jcg9mewy.result(predicateIds[x].id, $_cvcbgp167jcg9mewz.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        return $_3r0gh7166jcg9mewy.result(id, $_cvcbgp167jcg9mewz.getSelectionRect(editor));
      }
      return null;
    };
  };
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_eogzq216hjcg9mex8.isArray(value)) {
      return value;
    } else if ($_eogzq216hjcg9mex8.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_eogzq216hjcg9mex8.isBoolean(value)) {
  ...
  var $_c24f0u16gjcg9mex6 = {
    getStringOr: getByTypeOr($_eogzq216hjcg9mex8.isString),
    getBoolOr: getByTypeOr($_eogzq216hjcg9mex8.isBoolean),
    getNumberOr: getByTypeOr($_eogzq216hjcg9mex8.isNumber),
    getHandlerOr: getByTypeOr($_eogzq216hjcg9mex8.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_eogzq216hjcg9mex8.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_8q4pp9168jcg9mex0.toClientRect(targetRect),
        contentAreaRect: $_8q4pp9168jcg9mex0.toClientRect(contentAreaRect),
        panelRect: $_8q4pp9168jcg9mex0.toClientRect(panelRect)
      });
      return $_8q4pp9168jcg9mex0.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_c24f0u16gjcg9mex6.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_c24f0u16gjcg9mex6.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_c24f0u16gjcg9mex6.getHandlerOr(editor, 'inline_toolbar_position_handler', $_6ulixi16ijcg9mex9.defaultHandler);
  };
  ...
  var fireSkinLoaded = function (editor, callback) {
    var done = function () {
      ...
      $_dtqug16djcg9mex4.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_cxmkpq16ejcg9mex5.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded(editor, callback);
    };
    if ($_cxmkpq16ejcg9mex5.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_88ruxu16cjcg9mex4 = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_eby3je164jcg9mewx.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_1fojjy169jcg9mex1.fromContextToolbars(toolbars);
    result = $_3r0gh7166jcg9mewy.match(editor, [
      $_czahkv165jcg9mewy.element(elements[0], contextToolbarsPredicateIds),
      $_4ntmpe16bjcg9mex2.textSelection('text'),
      $_4ntmpe16bjcg9mex2.emptyTextBlock(elements, 'insert'),
      $_czahkv165jcg9mewy.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_3r0gh7166jcg9mewy.match(editor, [$_4ntmpe16bjcg9mex2.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_88ruxu16cjcg9mex4.load(editor, function () {
  ...
  var $_fowhm160jcg9mewu = { renderUI: renderUI };
  ...
  var never = $_1rqi6716njcg9mexm.never;
  var always = $_1rqi6716njcg9mexm.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_1rqi6716njcg9mexm.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var indexOf = function (xs, x) {
    ...
    return r === -1 ? $_9cpe3i16mjcg9mexl.none() : $_9cpe3i16mjcg9mexl.some(r);
  };
  ...
  var find = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_9cpe3i16mjcg9mexl.some(x);
      }
    }
    return $_9cpe3i16mjcg9mexl.none();
  };
  var findIndex = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_9cpe3i16mjcg9mexl.some(i);
      }
    }
    return $_9cpe3i16mjcg9mexl.none();
  };
  ...
  var head = function (xs) {
    return xs.length === 0 ? $_9cpe3i16mjcg9mexl.none() : $_9cpe3i16mjcg9mexl.some(xs[0]);
  };
  var last = function (xs) {
    return xs.length === 0 ? $_9cpe3i16mjcg9mexl.none() : $_9cpe3i16mjcg9mexl.some(xs[xs.length - 1]);
  };
  var $_3j1ynr16ljcg9mexi = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_66cio316ujcg9mey7.parseBox(settings.border);
      self.paddingBox = $_66cio316ujcg9mey7.parseBox(settings.padding);
      self.marginBox = $_66cio316ujcg9mey7.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_66cio316ujcg9mey7.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_66cio316ujcg9mey7.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_66cio316ujcg9mey7.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_fnq19r171jcg9meyr.remove(this);
  ...
  var NotificationManagerImpl = function (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_3j1ynr16ljcg9mexi.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_3j1ynr16ljcg9mexi.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_66cio316ujcg9mey7.parseBox(self.settings.border);
          ...
          self.borderBox = $_66cio316ujcg9mey7.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_fowhm160jcg9mewu.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_amrtzb15zjcg9mewt = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_7g9hne17ljcg9mf09.resolve(name, scope);
  };
  ...
  var $_9ahmrk17kjcg9mf07 = { getOrDie: getOrDie };

  var FileReader = function () {
    var f = $_9ahmrk17kjcg9mf07.getOrDie('FileReader');
    return new f();
  };
  ...
  var $_alj4gn17ijcg9mf04 = { blobToBase64: blobToBase64 };
  ...
  var $_7qhgs517ojcg9mf0a = { pickFile: pickFile };
  ...
  var $_dgrc317qjcg9mf0d = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_660gkh17sjcg9mf0f.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_660gkh17sjcg9mf0f.resolve(dom, bookmark));
  };
  ...
  var $_8wawtj17rjcg9mf0d = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_dgrc317qjcg9mf0d.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_8wawtj17rjcg9mf0d.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_fkqcr717pjcg9mf0b.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_7qhgs517ojcg9mf0a.pickFile().then(function (files) {
          var blob = files[0];
          $_alj4gn17ijcg9mf04.blobToBase64(blob).then(function (base64) {
            $_fkqcr717pjcg9mf0b.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_fkqcr717pjcg9mf0b.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_7um4u617hjcg9mf03 = { addToEditor: addToEditor };
  ...
  var getUiContainerDelta = function () {
    ...
    if (uiContainer && DOMUtils.DOM.getStyle(uiContainer, 'position', true) !== 'static') {
      ...
      return $_9cpe3i16mjcg9mexl.some({
        x: dx,
        y: dy
      });
    } else {
  ...
  var $_25voqm17wjcg9mf0k = { getUiContainerDelta: getUiContainerDelta };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_ckbgfj17yjcg9mf0t.isAbsolute(href) && $_ckbgfj17yjcg9mf0t.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_fkqcr717pjcg9mf0b.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_fkqcr717pjcg9mf0b.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_g0bfb917xjcg9mf0r = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_eogzq216hjcg9mex8.isArray(items)) {
      return items;
    } else if ($_eogzq216hjcg9mex8.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
  ...
  var $_fy6alb17zjcg9mf0u = { create: create$2 };

  var Panel$1 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_fy6alb17zjcg9mf0u.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_fy6alb17zjcg9mf0u.create(editor, 'text', $_cxmkpq16ejcg9mex5.getTextSelectionToolbarItems(editor)),
        $_fy6alb17zjcg9mf0u.create(editor, 'insert', $_cxmkpq16ejcg9mex5.getInsertToolbarItems(editor)),
        $_g0bfb917xjcg9mf0r.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_cxmkpq16ejcg9mex5.getPositionHandler(editor);
      contentAreaRect = $_cvcbgp167jcg9mewz.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_6ulixi16ijcg9mex9.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_6ulixi16ijcg9mex9.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_25voqm17wjcg9mf0k.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_6ulixi16ijcg9mex9.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_cvcbgp167jcg9mewz.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_6ulixi16ijcg9mex9.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_6ulixi16ijcg9mex9.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_dtqug16djcg9mex4.fireBeforeRenderUI(editor);
  ...
  var $_5wooeu18mjcg9mf23 = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_1rqi6716njcg9mexm.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return $_9cpe3i16mjcg9mexl.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_dmkc7b18njcg9mf24 = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_15jnrv18rjcg9mf2b = { cached: cached };

  var $_2wl5n318tjcg9mf2d = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_2wl5n318tjcg9mf2d.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_2wl5n318tjcg9mf2d.ELEMENT);
  var isText = isType$1($_2wl5n318tjcg9mf2d.TEXT);
  var isDocument = isType$1($_2wl5n318tjcg9mf2d.DOCUMENT);
  var $_60tbpx18sjcg9mf2c = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_60tbpx18sjcg9mf2c.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_15jnrv18rjcg9mf2b.cached(function () {
    return getBody($_dmkc7b18njcg9mf24.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_dmkc7b18njcg9mf24.fromDom(body);
  };
  var $_euzpb18qjcg9mf2a = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  var Immutable = function () {
    ...
    return function () {
      ...
      var struct = {};
      $_3j1ynr16ljcg9mexi.each(fields, function (name, i) {
        struct[name] = $_1rqi6716njcg9mexm.constant(values[i]);
      });
      return struct;
    };
  };
  ...
  var validateStrArr = function (label, array) {
    if (!$_cbt7m618vjcg9mf2m.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_3j1ynr16ljcg9mexi.each(array, function (a) {
      if (!$_cbt7m618vjcg9mf2m.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_3j1ynr16ljcg9mexi.find(sorted, function (s, i) {
  ...
  var MixedBag = function (required, optional) {
    ...
    $_fofupf190jcg9mf2v.validateStrArr('required', required);
    $_fofupf190jcg9mf2v.validateStrArr('optional', optional);
    $_fofupf190jcg9mf2v.checkDupes(everything);
    return function (obj) {
      var keys = $_1lam3x18zjcg9mf2t.keys(obj);
      var allReqd = $_3j1ynr16ljcg9mexi.forall(required, function (req) {
        return $_3j1ynr16ljcg9mexi.contains(keys, req);
      });
      if (!allReqd)
        $_fofupf190jcg9mf2v.reqMessage(required, keys);
      var unsupported = $_3j1ynr16ljcg9mexi.filter(keys, function (key) {
        return !$_3j1ynr16ljcg9mexi.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_fofupf190jcg9mf2v.unsuppMessage(unsupported);
      var r = {};
      $_3j1ynr16ljcg9mexi.each(required, function (req) {
        r[req] = $_1rqi6716njcg9mexm.constant(obj[req]);
      });
      $_3j1ynr16ljcg9mexi.each(optional, function (opt) {
        r[opt] = $_1rqi6716njcg9mexm.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? $_9cpe3i16mjcg9mexl.some(obj[opt]) : $_9cpe3i16mjcg9mexl.none());
      });
      return r;
    };
  };

  var $_6ilkwl18wjcg9mf2q = {
    immutable: Immutable,
  ...
  var $_472qb6191jcg9mf2w = { toArray: toArray };

  var node = function () {
    var f = $_9ahmrk17kjcg9mf07.getOrDie('Node');
    return f;
  };
  ...
  var unknown = function () {
    return nu({
      current: undefined,
      version: $_1pdh64197jcg9mf38.unknown()
    });
  };
  ...
  var $_9mdflm196jcg9mf36 = {
    unknown: unknown,
    nu: nu,
    edge: $_1rqi6716njcg9mexm.constant(edge),
    chrome: $_1rqi6716njcg9mexm.constant(chrome),
    ie: $_1rqi6716njcg9mexm.constant(ie),
    opera: $_1rqi6716njcg9mexm.constant(opera),
    firefox: $_1rqi6716njcg9mexm.constant(firefox),
    safari: $_1rqi6716njcg9mexm.constant(safari)
  };
  ...
  var $_2jn9to198jcg9mf38 = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_1rqi6716njcg9mexm.constant(windows$1),
    ios: $_1rqi6716njcg9mexm.constant(ios),
    android: $_1rqi6716njcg9mexm.constant(android),
    linux: $_1rqi6716njcg9mexm.constant(linux),
    osx: $_1rqi6716njcg9mexm.constant(osx),
    solaris: $_1rqi6716njcg9mexm.constant(solaris),
    freebsd: $_1rqi6716njcg9mexm.constant(freebsd)
  };
  ...
  var DeviceType = function (os, browser, userAgent) {
    ...
    return {
      isiPad: $_1rqi6716njcg9mexm.constant(isiPad),
      isiPhone: $_1rqi6716njcg9mexm.constant(isiPhone),
      isTablet: $_1rqi6716njcg9mexm.constant(isTablet),
      isPhone: $_1rqi6716njcg9mexm.constant(isPhone),
      isTouch: $_1rqi6716njcg9mexm.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_1rqi6716njcg9mexm.constant(iOSwebview)
    };
  };

  var detect$3 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_3j1ynr16ljcg9mexi.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$3(browsers, userAgent).map(function (browser) {
      var version = $_1pdh64197jcg9mf38.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$3(oses, userAgent).map(function (os) {
      var version = $_1pdh64197jcg9mf38.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var head$1 = function (str) {
    return str === '' ? $_9cpe3i16mjcg9mexl.none() : $_9cpe3i16mjcg9mexl.some(str.substr(0, 1));
  };
  var tail = function (str) {
    return str === '' ? $_9cpe3i16mjcg9mexl.none() : $_9cpe3i16mjcg9mexl.some(str.substring(1));
  };
  var $_cz5vuc19ejcg9mf3l = {
    first: first,
    last: last$1,
    head: head$1,
    tail: tail
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_aux4ry19djcg9mf3l.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_aux4ry19djcg9mf3l.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_aux4ry19djcg9mf3l.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_aux4ry19djcg9mf3l.addToEnd(str, prefix);
  };
  var contains$2 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_cz5vuc19ejcg9mf3l.head(str).bind(function (head) {
      return $_cz5vuc19ejcg9mf3l.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_fk6nwm19cjcg9mf3j.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_fk6nwm19cjcg9mf3j.contains(uastring, 'edge/') && $_fk6nwm19cjcg9mf3j.contains(uastring, 'chrome') && $_fk6nwm19cjcg9mf3j.contains(uastring, 'safari') && $_fk6nwm19cjcg9mf3j.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_fk6nwm19cjcg9mf3j.contains(uastring, 'chrome') && !$_fk6nwm19cjcg9mf3j.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_fk6nwm19cjcg9mf3j.contains(uastring, 'msie') || $_fk6nwm19cjcg9mf3j.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_fk6nwm19cjcg9mf3j.contains(uastring, 'safari') || $_fk6nwm19cjcg9mf3j.contains(uastring, 'mobile/')) && $_fk6nwm19cjcg9mf3j.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_fk6nwm19cjcg9mf3j.contains(uastring, 'iphone') || $_fk6nwm19cjcg9mf3j.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_6m6vvb19bjcg9mf3g = {
    browsers: $_1rqi6716njcg9mexm.constant(browsers),
    oses: $_1rqi6716njcg9mexm.constant(oses)
  };

  var detect$1 = function (userAgent) {
    var browsers = $_6m6vvb19bjcg9mf3g.browsers();
    var oses = $_6m6vvb19bjcg9mf3g.oses();
    var browser = $_3d3c0g19ajcg9mf3d.detectBrowser(browsers, userAgent).fold($_9mdflm196jcg9mf36.unknown, $_9mdflm196jcg9mf36.nu);
    var os = $_3d3c0g19ajcg9mf3d.detectOs(oses, userAgent).fold($_2jn9to198jcg9mf38.unknown, $_2jn9to198jcg9mf38.nu);
  ...
  var $_rqgs195jcg9mf35 = { detect: detect$1 };

  var detect = $_15jnrv18rjcg9mf2b.cached(function () {
    var userAgent = navigator.userAgent;
    return $_rqgs195jcg9mf35.detect(userAgent);
  });
  var $_7pv06t194jcg9mf33 = { detect: detect };

  var ELEMENT = $_2wl5n318tjcg9mf2d.ELEMENT;
  var DOCUMENT = $_2wl5n318tjcg9mf2d.DOCUMENT;
  ...
  var all$2 = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_3j1ynr16ljcg9mexi.map(base.querySelectorAll(selector), $_dmkc7b18njcg9mf24.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? $_9cpe3i16mjcg9mexl.none() : $_9cpe3i16mjcg9mexl.from(base.querySelector(selector)).map($_dmkc7b18njcg9mf24.fromDom);
  };
  var $_1vxjtu19fjcg9mf3m = {
    all: all$2,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_3j1ynr16ljcg9mexi.exists(elements, $_1rqi6716njcg9mexm.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_6r769v193jcg9mf32.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_7pv06t194jcg9mf33.detect().browser;
  var contains$1 = browser.isIE() ? ieContains : regularContains;
  var $_1dlg82192jcg9mf2x = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$1,
    is: $_1vxjtu19fjcg9mf3m.is
  };

  var owner = function (element) {
    return $_dmkc7b18njcg9mf24.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_dmkc7b18njcg9mf24.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_dmkc7b18njcg9mf24.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return $_9cpe3i16mjcg9mexl.from(dom.parentNode).map($_dmkc7b18njcg9mf24.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children$2(p);
      return $_3j1ynr16ljcg9mexi.findIndex(kin, function (elem) {
        return $_1dlg82192jcg9mf2x.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_cbt7m618vjcg9mf2m.isFunction(isRoot) ? isRoot : $_1rqi6716njcg9mexm.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_dmkc7b18njcg9mf24.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings$2 = function (element) {
    var filterSelf = function (elements) {
      return $_3j1ynr16ljcg9mexi.filter(elements, function (x) {
        return !$_1dlg82192jcg9mf2x.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return $_9cpe3i16mjcg9mexl.from(dom.offsetParent).map($_dmkc7b18njcg9mf24.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return $_9cpe3i16mjcg9mexl.from(dom.previousSibling).map($_dmkc7b18njcg9mf24.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return $_9cpe3i16mjcg9mexl.from(dom.nextSibling).map($_dmkc7b18njcg9mf24.fromDom);
  };
  var prevSiblings = function (element) {
    return $_3j1ynr16ljcg9mexi.reverse($_472qb6191jcg9mf2w.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_472qb6191jcg9mf2w.toArray(element, nextSibling);
  };
  var children$2 = function (element) {
    var dom = element.dom();
    return $_3j1ynr16ljcg9mexi.map(dom.childNodes, $_dmkc7b18njcg9mf24.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return $_9cpe3i16mjcg9mexl.from(children[index]).map($_dmkc7b18njcg9mf24.fromDom);
  };
  ...
  var spot = $_6ilkwl18wjcg9mf2q.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children$2(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_4v6y1x18ujcg9mf2e = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants$1($_euzpb18qjcg9mf2a.body(), predicate);
  };
  var ancestors$1 = function (scope, predicate, isRoot) {
    return $_3j1ynr16ljcg9mexi.filter($_4v6y1x18ujcg9mf2e.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_3j1ynr16ljcg9mexi.filter($_4v6y1x18ujcg9mf2e.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_3j1ynr16ljcg9mexi.filter($_4v6y1x18ujcg9mf2e.children(scope), predicate);
  };
  var descendants$1 = function (scope, predicate) {
    var result = [];
    $_3j1ynr16ljcg9mexi.each($_4v6y1x18ujcg9mf2e.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all = function (selector) {
    return $_1vxjtu19fjcg9mf3m.all(selector);
  };
  var ancestors = function (scope, selector, isRoot) {
    return $_du6ugy18pjcg9mf28.ancestors(scope, function (e) {
      return $_1vxjtu19fjcg9mf3m.is(e, selector);
    }, isRoot);
  };
  var siblings = function (scope, selector) {
    return $_du6ugy18pjcg9mf28.siblings(scope, function (e) {
      return $_1vxjtu19fjcg9mf3m.is(e, selector);
    });
  };
  var children = function (scope, selector) {
    return $_du6ugy18pjcg9mf28.children(scope, function (e) {
      return $_1vxjtu19fjcg9mf3m.is(e, selector);
    });
  };
  var descendants = function (scope, selector) {
    return $_1vxjtu19fjcg9mf3m.all(selector, scope);
  };
  var $_4jngzr18ojcg9mf27 = {
    all: all,
    ancestors: ancestors,
    siblings: siblings,
    children: children,
  ...
  var select = function (selector, root) {
    return $_3j1ynr16ljcg9mexi.map($_4jngzr18ojcg9mf27.descendants($_dmkc7b18njcg9mf24.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_5wooeu18mjcg9mf23.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$3('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_1rqi6716njcg9mexm.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_3j1ynr16ljcg9mexi.map($_3j1ynr16ljcg9mexi.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_3j1ynr16ljcg9mexi.map($_3j1ynr16ljcg9mexi.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$1 = function (elm) {
    ...
    return $_3j1ynr16ljcg9mexi.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_7ospv718ljcg9mf1y = { find: find$1 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_1rqi6716njcg9mexm.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_3j1ynr16ljcg9mexi.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_3j1ynr16ljcg9mexi.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_3j1ynr16ljcg9mexi.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_3j1ynr16ljcg9mexi.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_3j1ynr16ljcg9mexi.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_7ospv718ljcg9mf1y.find(bodyElm);
  ...
  var ClosestOrAncestor = function (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? $_9cpe3i16mjcg9mexl.some(scope) : $_cbt7m618vjcg9mf2m.isFunction(isRoot) && isRoot(scope) ? $_9cpe3i16mjcg9mexl.none() : ancestor(scope, a, isRoot);
  };

  var first$2 = function (predicate) {
    return descendant$1($_euzpb18qjcg9mf2a.body(), predicate);
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_dmkc7b18njcg9mf24.fromDom(element);
      if (predicate(el))
        return $_9cpe3i16mjcg9mexl.some(el);
      else if (stop(el))
        break;
    }
    return $_9cpe3i16mjcg9mexl.none();
  ...
  var sibling$1 = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return $_9cpe3i16mjcg9mexl.none();
    return child$2($_dmkc7b18njcg9mf24.fromDom(element.parentNode), function (x) {
      return !$_1dlg82192jcg9mf2x.eq(scope, x) && predicate(x);
    });
  };
  var child$2 = function (scope, predicate) {
    var result = $_3j1ynr16ljcg9mexi.find(scope.dom().childNodes, $_1rqi6716njcg9mexm.compose(predicate, $_dmkc7b18njcg9mf24.fromDom));
    return result.map($_dmkc7b18njcg9mf24.fromDom);
  };
  var descendant$1 = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_dmkc7b18njcg9mf24.fromDom(element.childNodes[i])))
          return $_9cpe3i16mjcg9mexl.some($_dmkc7b18njcg9mf24.fromDom(element.childNodes[i]));
  ...
  var first$1 = function (selector) {
    return $_1vxjtu19fjcg9mf3m.one(selector);
  };
  var ancestor = function (scope, selector, isRoot) {
    return $_78j5vh19ljcg9mf41.ancestor(scope, function (e) {
      return $_1vxjtu19fjcg9mf3m.is(e, selector);
    }, isRoot);
  };
  var sibling = function (scope, selector) {
    return $_78j5vh19ljcg9mf41.sibling(scope, function (e) {
      return $_1vxjtu19fjcg9mf3m.is(e, selector);
    });
  };
  var child$1 = function (scope, selector) {
    return $_78j5vh19ljcg9mf41.child(scope, function (e) {
      return $_1vxjtu19fjcg9mf3m.is(e, selector);
    });
  };
  var descendant = function (scope, selector) {
    return $_1vxjtu19fjcg9mf3m.one(selector, scope);
  };
  var closest = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_1vxjtu19fjcg9mf3m.is, ancestor, scope, selector, isRoot);
  };
  var $_da3md619kjcg9mf40 = {
    first: first$1,
    ancestor: ancestor,
    sibling: sibling,
    child: child$1,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_53cxh519ojcg9mf4a.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_53cxh519ojcg9mf4a.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_53cxh519ojcg9mf4a.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_53cxh519ojcg9mf4a.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_53cxh519ojcg9mf4a.postRenderFormat(editor, name)
      });
    });
  };
  var $_4r9ww819njcg9mf49 = { register: register };

  var getSpecifiedFontProp = function (propName, rootElm, elm) {
    while (elm !== rootElm) {
      if (elm.style[propName]) {
        var foundStyle = elm.style[propName];
        return foundStyle !== '' ? $_9cpe3i16mjcg9mexl.some(foundStyle) : $_9cpe3i16mjcg9mexl.none();
      }
      elm = elm.parentNode;
    }
    return $_9cpe3i16mjcg9mexl.none();
  ...
  var getComputedFontProp = function (propName, elm) {
    return $_9cpe3i16mjcg9mexl.from(DOMUtils.DOM.getStyle(elm, propName, true));
  };
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return $_9cpe3i16mjcg9mexl.from(elm).map($_dmkc7b18njcg9mf24.fromDom).filter($_60tbpx18sjcg9mf2c.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_ay8wys19qjcg9mf4d = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_1rqi6716njcg9mexm.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_ay8wys19qjcg9mf4d.getFontFamily(editor.getBody(), e.element);
  ...
  var $_d57d4p19pjcg9mf4b = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_ay8wys19qjcg9mf4d.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_ay8wys19qjcg9mf4d.toPt(px, precision);
  ...
  var $_gc12pu19rjcg9mf4g = { register: register$2 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_53cxh519ojcg9mf4a.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_53cxh519ojcg9mf4a.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_6g4bks19sjcg9mf4i = { register: register$3 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_53cxh519ojcg9mf4a.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_1nhcyx19tjcg9mf4k = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_3j1ynr16ljcg9mexi.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_3j1ynr16ljcg9mexi.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_3j1ynr16ljcg9mexi.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_1ihqpi19ujcg9mf4m = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_53cxh519ojcg9mf4a.postRenderFormat(editor, name),
        onclick: $_53cxh519ojcg9mf4a.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_53cxh519ojcg9mf4a.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_ehirgj19vjcg9mf4o = { register: register$6 };
  ...
  var $_8ae8s19wjcg9mf4q = { register: register$7 };
  ...
  var $_5i3gjr19xjcg9mf4r = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_da3md619kjcg9mf40.descendant($_dmkc7b18njcg9mf24.fromDom(document.body), editor.settings.ui_container).fold($_1rqi6716njcg9mexm.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_6g4bks19sjcg9mf4i.register(editor);
    $_4r9ww819njcg9mf49.register(editor);
    $_ehirgj19vjcg9mf4o.register(editor);
    $_8ae8s19wjcg9mf4q.register(editor);
    $_gc12pu19rjcg9mf4g.register(editor);
    $_d57d4p19pjcg9mf4b.register(editor);
    $_1nhcyx19tjcg9mf4k.register(editor);
    $_5i3gjr19xjcg9mf4r.register(editor);
    $_1ihqpi19ujcg9mf4m.register(editor);
  };
  var $_dl1aio19jjcg9mf3u = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_fnq19r171jcg9meyr,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_f2xw0317ejcg9mezx,
      Panel: Panel,
      Movable: $_2is6u9172jcg9meys,
      Resizable: $_euq0ur17fjcg9mf00,
      ...
      FormatControls: $_dl1aio19jjcg9mf3u,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = Panel$1();
    $_dl1aio19jjcg9mf3u.setup(editor);
    $_7um4u617hjcg9mf03.addToEditor(editor, panel);
    return $_amrtzb15zjcg9mewt.get(editor, panel);
  });
  var Theme = function () {
  };
