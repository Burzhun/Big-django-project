...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_fubrf29djcg9maaa.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_1cjf5u99jcg9ma9j.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_54lvoz9bjcg9ma9k.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_8sgfpe98jcg9ma9h = {
    open: function (editor) {
      var minWidth = $_1cjf5u99jcg9ma9j.getDialogMinWidth(editor);
      var minHeight = $_1cjf5u99jcg9ma9j.getDialogMinHeight(editor);
      var currentLanguage = $_c5pv9ejcg9maab.getCurrentLanguage(editor);
      var currentLanguages = $_c5pv9ejcg9maab.getLanguages(editor);
      var currentCode = $_54lvoz9bjcg9ma9k.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_54lvoz9bjcg9ma9k.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_fubrf29djcg9maaa.isCodeSample(node)) {
        $_8sgfpe98jcg9ma9h.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_bxgcxt97jcg9ma9g = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_fubrf29djcg9maaa.trimArg($_fubrf29djcg9maaa.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_fubrf29djcg9maaa.trimArg($_fubrf29djcg9maaa.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_f31dwb9fjcg9maah = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_1cjf5u99jcg9ma9j.getContentCss(editor);
  ...
  var $_gce029gjcg9maaj = { loadCss: loadCss };
  ...
  var $_62aglc9hjcg9maak = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_f31dwb9fjcg9maah.setup(editor);
    $_62aglc9hjcg9maak.register(editor);
    $_bxgcxt97jcg9ma9g.register(editor);
    editor.on('init', function () {
      $_gce029gjcg9maaj.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_fubrf29djcg9maaa.isCodeSample(ev.target)) {
        $_8sgfpe98jcg9ma9h.open(editor);
      }
    });
  });
