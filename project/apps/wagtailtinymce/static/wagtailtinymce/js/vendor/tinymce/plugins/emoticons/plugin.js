...
var emoticons = (function () {
  ...
  var $_g63bnfa7jcg9macq = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_g63bnfa7jcg9macq.getHtml(pluginUrl);
  ...
  var $_g7e2g8a6jcg9macp = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_g7e2g8a6jcg9macp.register(editor, pluginUrl);
  });
  var Plugin = function () {
  };
