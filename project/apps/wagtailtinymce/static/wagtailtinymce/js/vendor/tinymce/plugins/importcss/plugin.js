...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_6q1k4ndvjcg9mau3.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_6q1k4ndvjcg9mau3.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_6q1k4ndvjcg9mau3.getSelectorConverter(editor)) {
      selectorConverter = $_6q1k4ndvjcg9mau3.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_6q1k4ndvjcg9mau3.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_6q1k4ndvjcg9mau3.getCssGroups(editor));
      ...
      if (!$_6q1k4ndvjcg9mau3.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_6q1k4ndvjcg9mau3.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_b80adfdqjcg9matx.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_2dhqbldpjcg9matv = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_b80adfdqjcg9matx.setup(editor);
    return $_2dhqbldpjcg9matv.get(editor);
  });
  var Plugin = function () {
  };
