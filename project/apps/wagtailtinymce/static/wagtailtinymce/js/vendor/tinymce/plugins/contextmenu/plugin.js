...
var contextmenu = (function () {
  ...
  var $_96ct399sjcg9mabx = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_c4gc1p9rjcg9mabw.getContextMenu(editor);
  ...
  var $_ojejp9vjcg9mabz = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_c4gc1p9rjcg9mabw.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_ojejp9vjcg9mabz.show(editor, $_96ct399sjcg9mabx.getPos(editor, e), visibleState, menu);
    });
  };
  var $_3m516l9qjcg9mabv = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_3m516l9qjcg9mabv.setup(editor, visibleState, menu);
    return $_ajnsgu9pjcg9mabu.get(visibleState);
  });
  var Plugin = function () {
  };
