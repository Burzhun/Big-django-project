...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_bqt7i8hvjcg9mb5g.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_bqt7i8hvjcg9mb5g.getPreviewDialogWidth(editor);
    var dialogHeight = $_bqt7i8hvjcg9mb5g.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_f3vhuvhwjcg9mb5h.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_bcj4ahhtjcg9mb5f = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_bcj4ahhtjcg9mb5f.open(editor);
    });
  };
  var $_8e76z7hsjcg9mb5e = { register: register };
  ...
  var $_2mqms4hyjcg9mb5j = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_8e76z7hsjcg9mb5e.register(editor);
    $_2mqms4hyjcg9mb5j.register(editor);
  });
  var Plugin = function () {
  };
