...
class ImageText(object):
    def __init__(self, filename_or_size_or_image, mode='RGBA', background=(0, 0, 0, 0)):
        print(filename_or_size_or_image, type(filename_or_size_or_image))
        if isinstance(filename_or_size_or_image, str):
            ...
            self.filename = None
        elif type(filename_or_size_or_image) is Image.Image:
            self.size = filename_or_size_or_image.size
    ...
    def write_text_box(self, xy, text, box_width, font_filename,
                       ...
                       justify_last_line=False, fake=False):
        self.fake = fake
        x, y = xy
        lines = []
        line = []
